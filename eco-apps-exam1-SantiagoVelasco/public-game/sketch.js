...
socket.on('game-display',instruction =>{
    console.log(`Llegó esta direction ${instruction}`);

    player.xDirection = instruction
})
...
async function sendScore(point) {
    ...
    await fetch('http://localhost:8080/score', request)
}
